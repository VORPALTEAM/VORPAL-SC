...
contract VorpalNFT is Initializable, ERC721EnumerableUpgradeable, AccessControlUpgradeable, ReentrancyGuardUpgradeable {
    ...
    function initialize(
        ...
        __ERC721_init("VorpalRobbiesEarn", "BRE");
